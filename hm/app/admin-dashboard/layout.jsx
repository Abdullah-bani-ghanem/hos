            ...
            <aside className="w-64 bg-gray-100 p-4 border-r border-gray-200 flex flex-col justify-between">
                <div>
                    ...
                    <nav className="flex flex-col gap-4 text-sm">
                        ...
                        <Link href="/admin-dashboard/schedule" className="text-amber-950 hover:text-blue-600">جدولة الأطباء</Link>
                        <Link href="/admin-dashboard/patients/new" className="inline-block mb-4 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700"
                        >
                            + إضافة مريض
                        </Link>
